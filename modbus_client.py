...
class ModbusClient:
    ...
    def write_register_1311_direct(self, value: int) -> bool:
        """Запись setpoint напряжения Magnet PSU (регистр 1311, V×100)."""
        return self.write_register_direct(1311, value)
