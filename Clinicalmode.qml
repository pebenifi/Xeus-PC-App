            ...
            ScrollView {
                ...
                Column {
                    ...
                    Column {
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditionalNitrogenAlicatsPressureValue(val)
                                            modbusManager.setAdditionalNitrogenAlicatsPressure(val)
                                        }
                                    }
                                }
                                Text { text: "Torr"; font.pixelSize: 11; color: "#666666"; anchors.verticalCenter: parent.verticalCenter }
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditionalChillerTempSetpointValue(val)
                                            modbusManager.setAdditionalChillerTempSetpoint(val)
                                        }
                                    }
                                }
                                Button {
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditionalSEOPResonanceFrequencyValue(val)
                                            modbusManager.setAdditionalSEOPResonanceFrequency(val)
                                        }
                                    }
                                }
                        ...
                        // SEOP Resonance Frequency Tolerance
                        Row {
                            width: parent.width
                            spacing: 16
                            padding: 4
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditionalSEOPResonanceFrequencyToleranceValue(val)
                                            modbusManager.setAdditionalSEOPResonanceFrequencyTolerance(val)
                                        }
                                    }
                                }
                                Button {
                        ...
                        // IR spectrometer number of scans
                        Row {
                            width: parent.width
                            spacing: 16
                            padding: 4
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditionalIRSpectrometerNumberOfScansValue(val)
                                            modbusManager.setAdditionalIRSpectrometerNumberOfScans(val)
                                        }
                                    }
                                }
                                Button {
                        ...
                        // IR spectrometer exposure duration
                        Row {
                            width: parent.width
                            spacing: 16
                            padding: 4
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditionalIRSpectrometerExposureDurationValue(val)
                                            modbusManager.setAdditionalIRSpectrometerExposureDuration(val)
                                        }
                                    }
                                }
                                Text { text: "ms"; font.pixelSize: 11; color: "#666666"; anchors.verticalCenter: parent.verticalCenter }
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditional1HReferenceNScansValue(val)
                                            modbusManager.setAdditional1HReferenceNScans(val)
                                        }
                                    }
                                }
                                Button {
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditional1HCurrentSweepNScansValue(val)
                                            modbusManager.setAdditional1HCurrentSweepNScans(val)
                                        }
                                    }
                                }
                                Button {
                        ...
                        // Baseline correction min frequency
                        Row {
                            width: parent.width
                            spacing: 16
                            padding: 4
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditionalBaselineCorrectionMinFrequencyValue(val)
                                            modbusManager.setAdditionalBaselineCorrectionMinFrequency(val)
                                        }
                                    }
                                }
                                Text { text: "kHz"; font.pixelSize: 11; color: "#666666"; anchors.verticalCenter: parent.verticalCenter }
                        ...
                        // Baseline correction max frequency
                        Row {
                            width: parent.width
                            spacing: 16
                            padding: 4
                            ...
                            Row {
                                ...
                                TextField {
                                    ...
                                    onEditingFinished: {
                                        var val = parseFloat(text)
                                        if (!isNaN(val) && modbusManager) {
                                            modbusManager.setAdditionalBaselineCorrectionMaxFrequencyValue(val)
                                            modbusManager.setAdditionalBaselineCorrectionMaxFrequency(val)
                                        }
                                    }
                                }
                                Text { text: "kHz"; font.pixelSize: 11; color: "#666666"; anchors.verticalCenter: parent.verticalCenter }
                        ...
                        Connections {
                            ...
                            function onAdditionalSEOPResonanceFrequencyChanged(value) {
                                if (!additionalSEOPResonanceFrequency.activeFocus) {
                                    additionalSEOPResonanceFrequency.text = value.toFixed(2)
                                }
                            }
                            ...
                            function onAdditionalIRSpectrometerNumberOfScansChanged(value) {
                                if (!additionalIRSpectrometerNumberOfScans.activeFocus) {
                                    additionalIRSpectrometerNumberOfScans.text = value.toFixed(0)
                                }
                            }
                            ...
                            function onAdditional1HReferenceNScansChanged(value) {
                                if (!additional1HReferenceNScans.activeFocus) {
                                    additional1HReferenceNScans.text = value.toFixed(0)
                                }
                            }
                            function onAdditional1HCurrentSweepNScansChanged(value) {
                                if (!additional1HCurrentSweepNScans.activeFocus) {
                                    additional1HCurrentSweepNScans.text = value.toFixed(0)
                                }
                            }
                            function onAdditionalBaselineCorrectionMinFrequencyChanged(value) {
                                if (!additionalBaselineCorrectionMinFrequency.activeFocus) {
                                    additionalBaselineCorrectionMinFrequency.text = value.toFixed(2)
                                }
                            }
                            function onAdditionalBaselineCorrectionMaxFrequencyChanged(value) {
                                if (!additionalBaselineCorrectionMaxFrequency.activeFocus) {
                                    additionalBaselineCorrectionMaxFrequency.text = value.toFixed(2)
                                }
                            }
                        }
                    }
