...
# Windows build configuration for XeusGUI
...
# Windows: создаем один исполняемый файл (onefile) или папку (onedir)
# Используем onedir для лучшей производительности и возможности отладки
exe = EXE(
    pyz,
    a.scripts,
    [],
...
# Для Windows не нужна секция BUNDLE (это только для macOS)
